<section class="bg-black text-white p-5 lg:p-10 space-y-12 min-h-screen relative overflow-hidden">
    ...
    <div class="text-center relative z-10">
        <div
            ...
            <span class="text-primary-light text-xs md:text-sm font-bold tracking-widest uppercase">PREMIUM EXPERIENCE</span>
            <div class="w-3 h-3 bg-primary-dark rounded-full animate-pulse shadow-lg shadow-primary-dark/50"
                style="animation-delay: 0.5s;"></div>
        </div>
        <h1 class="font-black text-3xl lg:text-6xl leading-none tracking-tight mb-4">
            <span class="block text-white drop-shadow-lg">Langganan Lebih Ringan</span>
        </h1>
        <p class="md:mt-8 mt-2 text-gray-300 text-sm lg:text-2xl font-light max-w-3xl mx-auto leading-relaxed">
