{{-- popup poster --}}
@if (setting('popup.information'))
    <div x-data="{ open: false }" 
         x-init="setTimeout(() => open = true, 1500)" 
         x-show="open"
         x-transition:enter="transition ease-out duration-500 z-50"
...
=======
        <div class="bg-white md:max-h-[800vh] rounded-2xl shadow-2xl md:max-w-md w-[80%] mx-auto text-center relative">
            ...
            <button @click="open = false"
                class="absolute md:-top-8 md:-right-8 -top-6 -right-6 rounded-full w-5 h-5 md:w-6 md:h-6 text-primary bg-white hover:text-gray-700 flex justify-center items-center">
