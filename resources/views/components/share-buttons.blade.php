 ...
 <script>
     document.addEventListener("DOMContentLoaded", function() {
         ...
         // Twitter
         document.querySelector(".share-button:nth-child(1)").addEventListener("click", () => {
             const url = `https://twitter.com/intent/tweet?url=${pageUrl}&text=${pageTitle}`;
             window.open(url, "_blank");
         });

         // Facebook
         document.querySelector(".share-button:nth-child(2)").addEventListener("click", () => {
             const url = `https://www.facebook.com/sharer/sharer.php?u=${pageUrl}`;
             window.open(url, "_blank");
         });

         // WhatsApp
         document.querySelector(".share-button:nth-child(3)").addEventListener("click", () => {
