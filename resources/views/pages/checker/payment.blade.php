    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="card-glass p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold text-gray-900 text-right">{{ $order->service->name }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <a href="{{ route('checker.track.detail', $order->invoice_number) }}" class="block w-full card-glass p-4 text-center font-bold text-sm transition-colors hover:bg-gray-50" style="color:#FF3C5F; border:1px solid rgba(255,60,95,0.2)">
                    Cek Status di Halaman Pelacakan &rarr;
                </a>
