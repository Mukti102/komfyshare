<div class="w-full py-10  relative ">
      ...
      <div class="absolute inset-0 ">
         <div class="absolute top-20 -left-60 w-[20rem]  h-[20rem] bg-blue-800/80 rounded-full blur-2xl floating-animation"></div>
         <div class="absolute bottom-10 -right-60 w-[20rem]  h-[20rem] bg-blue-800/60 rounded-full blur-2xl floating-animation"></div>
         <div class="absolute top-40 right-20 w-24 h-24  bg-blue-800/40 rounded-full blur-xl floating-animation-delayed">
         </div>
         <div class="absolute bottom-20 left-1/4 w-40  h-40 bg-blue-800/40 rounded-full blur-2xl floating-animation"></div>
         <div class="absolute bottom-10 left-1/4 w-40  h-40 bg-blue-800/40 rounded-full blur-2xl floating-animation"></div>
     </div>

     <div class="relative z-50 px-6 py-4 
            rounded-3xl 
            bg-white/10 
                 ...
                 <div class="relative overflow-hidden   mx-0 md:mx-8 lg:mx-0">
                     <div id="categorySlider"
                         ...
                         <button wire:click="$set('activeCategory', 'all')"
                             ...
                             <!-- Active Background -->
                             <div class="absolute inset-0 bg-gray-50  opacity-0 transition-opacity duration-300 rounded-full">
                             </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            slider.addEventListener('touchmove', (e) => {
                ...
                const newTranslate = Math.max(0, Math.min(maxTranslate, currentTranslate + diffX));
