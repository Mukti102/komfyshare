 ...
 <!-- Hero Section -->
 <section
     class="bg-[url('https://i.pinimg.com/1200x/38/9a/39/389a39ad3a2e8005f2cd2330170694e5.jpg')] bg-no-repeat bg-cover md:min-h-screen h-[40rem] relative overflow-hidden">
     <!-- Background Elements -->
     ...
     <div
         class="h-full w-[70%] px-20   bg-gradient-to-r from-[30%] md:from-[40%]  from-black/80 to-transparent   relative z-50 flex items-center justify-center">
